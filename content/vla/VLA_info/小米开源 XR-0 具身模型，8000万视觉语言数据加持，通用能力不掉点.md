...
作者：沪中漫笔@知乎 [链接](https://zhuanlan.zhihu.com/p/2005777328626754671)

大模型直接控制机器人的最大痛点，往往是高昂的推理延迟导致的动作卡顿甚至失控。最新开源的视觉-语言-动作（VLA）模型 Xiaomi-Robotics-0 巧妙结合了 Qwen3-VL 与 DiT 扩散架构，并通过独创的异步执行策略让机器人真正学会了无缝衔接的“边走边想”。这套方案不仅完美掩盖了推理延迟，更在单张 RTX 4090 上跑出了 80ms 的极致平滑控制，本文带来详细代码解读。

- **论文标题**：Xiaomi-Robotics-0: An Open-Sourced Vision-Language-Action Model with Real-Time Execution
- **代码仓库**：[https://github.com/XiaomiRobotics/Xiaomi-Robotics-0](https://github.com/XiaomiRobotics/Xiaomi-Robotics-0)
- **论文链接**：[https://xiaomi-robotics-0.github.io/](https://xiaomi-robotics-0.github.io/)
