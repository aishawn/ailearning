#!/usr/bin/env python3
"""
Generate `public/logo.svg` and `public/favicon.ico` for AIShawn Quick Start.
...
def _repo_root_from_this_file() -> Path:
    # .../.claude/skills/aishawn-quick-start/scripts/generate-logo.py
    # parents[0]=scripts, [1]=aishawn-quick-start, [2]=skills, [3]=.claude, [4]=repo root
