---
name: aishawn-quick-start
description: Automate first-pass customization of a new AIShawn (AIShawn Two) project from a short project brief (app name, domain/app URL, product description/features, reference links, and branding preferences). Use when the user says they are starting a new project.
---

# AIShawn Quick Start (Project Bootstrap)
...
- After finishing all edits: **clear Next.js cache** before validation, otherwise you may see stale assets (e.g. old `logo.svg`):
