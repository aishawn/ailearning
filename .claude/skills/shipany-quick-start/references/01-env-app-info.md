...
Make app URL/name/description/logo consistent via env files (AIShawn Two follows env → `src/config/index.ts` → `envConfigs`).
...
- Set at minimum:
  ...
  - `NEXT_PUBLIC_APP_LOGO` = `/logo.svg` or `/logo.svg`
