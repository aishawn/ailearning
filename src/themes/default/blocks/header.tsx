          ...
          {header.nav?.items?.map((item, idx) => {
              ...
              return (
                <NavigationMenuLink key={idx} asChild>
                  <Link
                    ...
                    className={`flex flex-row items-center gap-2 px-4 h-8 text-sm ${
            ...
            return (
              <NavigationMenuItem key={idx}>
                <NavigationMenuTrigger className="flex flex-row items-center gap-2 !h-8 !py-0 text-sm !text-foreground">
                  {item.icon && (
  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'absolute inset-x-0 top-0 z-50 h-18 border-b border-white/20 ring-1 ring-transparent transition-all duration-300',
        ...
        >
          <div className="mx-auto max-w-[90rem] px-4 md:px-8">
            <div className="relative flex flex-wrap items-center justify-between h-18 max-lg:h-14">
                <div className="flex items-center justify-between gap-8 max-lg:w-full max-lg:border-b max-lg:h-14 lg:h-18">
                {/* Brand Logo */}
              ...
              <div className="mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 in-data-[state=active]:flex max-lg:in-data-[state=active]:mt-6 md:flex-nowrap lg:mb-0 lg:flex lg:w-fit lg:h-18 lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                <div className="flex w-full flex-row items-center gap-4 sm:flex-row sm:gap-6 sm:space-y-0 md:w-fit lg:h-18">
                  {header.buttons &&
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          button.variant === 'outline'
                            ? 'bg-white text-black border-black hover:bg-gray-50 border shadow-sm duration-200'
                            : 'bg-white text-black border-black hover:bg-gray-50 border shadow-sm duration-200'
                        )}
                      >
                        {/* {button.icon && (
