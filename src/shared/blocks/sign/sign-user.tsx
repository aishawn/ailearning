      ...
      {isCheckSign || !mounted ? (
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar>
                ...
                />
                <AvatarFallback className="text-lg font-semibold">{displayUser.name.charAt(0)}</AvatarFallback>
              </Avatar>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
        ...
        <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
          <Button
            ...
            variant="outline"
            className={cn(
              'ml-4 cursor-pointer ring-0 rounded-full gap-2',
              'bg-black text-white border-2 border-gray-300 hover:bg-black/90 hover:text-white',
          ...
          >
            <span className="flex items-center gap-2">
              {t('sign_in_title')}
              <span className="flex size-5 items-center justify-center rounded-full bg-white border-2 border-gray-400">
                <SmartIcon name="ArrowUpRight" className="size-3 text-black" />
              </span>
            </span>
          </Button>
          <SignModal />
