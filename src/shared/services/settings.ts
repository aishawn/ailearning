...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      description:
        'custom your <a href="https://affonso.io?atp=aishawn" class="text-primary" target="_blank">Affonso</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'promotekit',
      ...
      description:
        'custom your <a href="https://www.promotekit.com?via=aishawn" class="text-primary" target="_blank">PromoteKit</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'crisp',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'AIShawn is a NextJS boilerplate for building AI SaaS startups. ',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'AIShawn Two <no-reply@mail.aishawn.site>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: '',
      tip: 'Cloudflare Account ID (optional, used for constructing default endpoint)',
      group: 'r2',
      tab: 'storage',
    },
    {
